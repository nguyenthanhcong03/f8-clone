...
const CreateBlogPage = () => {
  ...
  const { data } = useGetAllCategoriesQuery({ limit: 5 })
        ...
        <div className='mx-auto w-full px-6 py-4'>
          <div className='flex items-center justify-between'>
            ...
            >
              ...
              {isSubmitting || isCreating ? 'Đang tạo...' : 'Tạo bài viết'}
            </Button>
          </div>
        </div>
      </div>
      ...
      <div className='mx-auto w-full max-w-7xl overflow-y-auto p-6'>
        <Card className='border bg-white'>
          <CardHeader className='border-b bg-gradient-to-r from-blue-50 to-indigo-50 px-8 py-6'>
            ...
            <p className='mt-2 text-sm text-gray-600'>Điền thông tin để tạo bài viết mới</p>
          </CardHeader>
